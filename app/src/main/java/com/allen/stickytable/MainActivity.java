...
public class MainActivity extends Activity implements CHScrollViewListener {
    ...
    class ScrollAdapter extends SimpleAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (v == null) {
                ...
                //第一次初始化的时候装进来
                ((CHScrollViewListener) context).addHViews((CHScrollView) v.findViewById(R.id.item_scroll));
